 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Y({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const r=B(t),i=H(t),s=e.getImmediate({optional:!0});if(s){const t=await s.getHeartbeatsHeader();t&&i.append("x-firebase-client",t)}const o={fid:n,authVersion:R,appId:t.appId,sdkVersion:L},a={method:"POST",headers:i,body:JSON.stringify(o)},c=await W((()=>fetch(r,a)));if(c.ok){const t=await c.json(),e={fid:t.fid||n,registrationStatus:2,refreshToken:t.refreshToken,authToken:q(t.authToken)};return e}throw await z("Create Installation",c)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qt="installations",zt="installations-internal",Ht=t=>{const e=t.getProvider("app").getImmediate(),n=Ut(e),i=(0,r.qX)(e,"heartbeat"),s={app:e,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()};return s},Kt=t=>{const e=t.getProvider("app").getImmediate(),n=(0,r.qX)(e,qt).getImmediate(),i={getId:()=>jt(n),getToken:t=>$t(n,t)};return i};function Wt(){(0,r.Xd)(new o.wA(qt,Ht,"PUBLIC")),(0,r.Xd)(new o.wA(zt,Kt,"PRIVATE"))}Wt(),(0,r.KN)(D,O),(0,r.KN)(D,O,"esm2017");
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function qi(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function zi(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function Hi(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lo{constructor(){this._=void 0}}function Ro(t,e,n){return t instanceof Fo?function(t,e){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:t.seconds,nanos:t.nanoseconds}}}};return e&&is(e)&&(e=ss(e)),e&&(n.fields.__previous_value__=e),{mapValue:n}}(n,e):t instanceof jo?$o(t,e):t instanceof Vo?Uo(t,e):function(t,e){const n=Mo(t,e),r=qo(n)+qo(t.Te);return ys(n)&&ys(t.Te)?No(r):Oo(t.serializer,r)}(t,e)}function Po(t,e,n){return t instanceof jo?$o(t,e):t instanceof Vo?Uo(t,e):n}function Mo(t,e){return t instanceof Bo?function(t){return ys(t)||function(t){return!!t&&"doubleValue"in t}(t)}(e)?e:{integerValue:0}:null}class Fo extends Lo{}class jo extends Lo{constructor(t){super(),this.elements=t}}function $o(t,e){const n=zo(e);for(const r of t.elements)n.some((t=>hs(t,r)))||n.push(r);return{arrayValue:{values:n}}}class Vo extends Lo{constructor(t){super(),this.elements=t}}function Uo(t,e){let n=zo(e);for(const r of t.elements)n=n.filter((t=>!hs(t,r)));return{arrayValue:{values:n}}}class Bo extends Lo{constructor(t,e){super(),this.serializer=t,this.Te=e}}function qo(t){return ns(t.integerValue||t.doubleValue)}function zo(t){return vs(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nc{constructor(t){this.ht=t}}function rc(t){const e=Ha({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?lo(e,e.limit,"L"):e}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zc="WebChannelConnection";class Hc extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const e=t.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.po=e+"://"+t.host,this.yo=`projects/${n}/databases/${r}`,this.wo="(default)"===this.databaseId.database?`project_id=${n}`:`project_id=${n}&database_id=${r}`}get So(){return!1}bo(t,e,n,r,i){const s=Uc(),o=this.Do(t,e);Jr("RestConnection",`Sending RPC '${t}' ${s}:`,o,n);const a={"google-cloud-resource-prefix":this.yo,"x-goog-request-params":this.wo};return this.Co(a,r,i),this.vo(t,o,a,n).then((e=>(Jr("RestConnection",`Received RPC '${t}' ${s}: `,e),e)),(e=>{throw ti("RestConnection",`RPC '${t}' ${s} failed with error: `,e,"url: ",o,"request:",n),e}))}Fo(t,e,n,r,i,s){return this.bo(t,e,n,r,i)}Co(t,e,n){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Qr}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach(((e,n)=>t[n]=e)),n&&n.headers.forEach(((e,n)=>t[n]=e))}Do(t,e){const n=Bc[t];return`${this.po}/v1/${e}:${n}`}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}vo(t,e,n,r){const i=Uc();return new Promise(((s,o)=>{const a=new zr;a.setWithCredentials(!0),a.listenOnce(Vr.COMPLETE,(()=>{try{switch(a.getLastErrorCode()){case $r.NO_ERROR:const e=a.getResponseJson();Jr(zc,`XHR for RPC '${t}' ${i} received:`,JSON.stringify(e)),s(e);break;case $r.TIMEOUT:Jr(zc,`RPC '${t}' ${i} timed out`),o(new oi(si.DEADLINE_EXCEEDED,"Request time out"));break;case $r.HTTP_ERROR:const n=a.getStatus();if(Jr(zc,`RPC '${t}' ${i} failed with status:`,n,"response text:",a.getResponseText()),n>0){let t=a.getResponseJson();Array.isArray(t)&&(t=t[0]);const e=null==t?void 0:t.error;if(e&&e.status&&e.message){const t=function(t){const e=t.toLowerCase().replace(/_/g,"-");return Object.values(si).indexOf(e)>=0?e:si.UNKNOWN}(e.status);o(new oi(t,e.message))}else o(new oi(si.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new oi(si.UNAVAILABLE,"Connection failed."));break;default:ni()}}finally{Jr(zc,`RPC '${t}' ${i} completed.`)}}));const c=JSON.stringify(r);Jr(zc,`RPC '${t}' ${i} sending request:`,r),a.send(e,"POST",c,n,15)}))}Mo(t,e,n){const r=Uc(),i=[this.po,"/","google.firestore.v1.Firestore","/",t,"/channel"],s=Fr(),o=jr(),a={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;void 0!==c&&(a.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(a.useFetchStreams=!0),this.Co(a.initMessageHeaders,e,n),a.encodeInitMessageHeaders=!0;const l=i.join("");Jr(zc,`Creating RPC '${t}' stream ${r}: ${l}`,a);const u=s.createWebChannel(l,a);let h=!1,f=!1;const d=new qc({ho:e=>{f?Jr(zc,`Not sending because RPC '${t}' stream ${r} is closed:`,e):(h||(Jr(zc,`Opening RPC '${t}' stream ${r} transport.`),u.open(),h=!0),Jr(zc,`RPC '${t}' stream ${r} sending:`,e),u.send(e))},Po:()=>u.close()}),p=(t,e,n)=>{t.listen(e,(t=>{try{n(t)}catch(t){setTimeout((()=>{throw t}),0)}}))};return p(u,qr.EventType.OPEN,(()=>{f||Jr(zc,`RPC '${t}' stream ${r} transport opened.`)})),p(u,qr.EventType.CLOSE,(()=>{f||(f=!0,Jr(zc,`RPC '${t}' stream ${r} transport closed`),d.mo())})),p(u,qr.EventType.ERROR,(e=>{f||(f=!0,ti(zc,`RPC '${t}' stream ${r} transport errored:`,e),d.mo(new oi(si.UNAVAILABLE,"The operation could not be completed")))})),p(u,qr.EventType.MESSAGE,(e=>{var n;if(!f){const i=e.data[0];ri(!!i);const s=i,o=s.error||(null===(n=s[0])||void 0===n?void 0:n.error);if(o){Jr(zc,`RPC '${t}' stream ${r} received error:`,o);const e=o.status;let n=function(t){const e=ca[t];if(void 0!==e)return ua(e)}(e),i=o.message;void 0===n&&(n=si.INTERNAL,i="Unknown error status: "+e+" with message "+o.message),f=!0,d.mo(new oi(n,i)),u.close()}else Jr(zc,`RPC '${t}' stream ${r} received:`,i),d.fo(i)}})),p(o,Ur.STAT_EVENT,(e=>{e.stat===Br.PROXY?Jr(zc,`RPC '${t}' stream ${r} detected buffering proxy`):e.stat===Br.NOPROXY&&Jr(zc,`RPC '${t}' stream ${r} detected no buffering proxy`)})),setTimeout((()=>{d.Vo()}),0),d}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.dd77526c.js.map